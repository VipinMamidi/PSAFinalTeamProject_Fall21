...
public abstract class BaseHuskySequenceCoder<X extends CharSequence> implements HuskySequenceCoder<X> {
     ...
     */
    @Override
    final public FinalTeamProject_Fall2021_Sec06.huskySort.sort.huskySortUtils.Coding huskyEncode(final X[] xs) {
        ...
        return new FinalTeamProject_Fall2021_Sec06.huskySort.sort.huskySortUtils.Coding(result, isPerfect);
    }

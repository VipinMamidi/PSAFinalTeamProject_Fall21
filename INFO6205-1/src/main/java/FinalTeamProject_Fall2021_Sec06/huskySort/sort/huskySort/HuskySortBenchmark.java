...
import FinalTeamProject_Fall2021_Sec06.huskySort.sort.huskySortUtils.HuskySortHelper;
import FinalTeamProject_Fall2021_Sec06.huskySort.sort.huskySortUtils.HuskySortable;
import FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.*;
import FinalTeamProject_Fall2021_Sec06.huskySort.util.*;
...
import static FinalTeamProject_Fall2021_Sec06.huskySort.sort.huskySort.AbstractHuskySort.UNICODE_CODER;
import static FinalTeamProject_Fall2021_Sec06.huskySort.sort.huskySortUtils.HuskyCoderFactory.englishCoder;
import static FinalTeamProject_Fall2021_Sec06.huskySort.sort.huskySortUtils.HuskySortHelper.generateRandomLocalDateTimeArray;
import static FinalTeamProject_Fall2021_Sec06.huskySort.util.Utilities.*;
...
public final class HuskySortBenchmark {
    ...
    void benchmarkStringSortersInstrumented(final String[] words, final int nWords, final int nRuns, final HuskyCoder<String> huskyCoder) {
        ...
        if (isConfigBenchmarkStringSorter("huskybucketsort")) {
            final SortWithHelper<String> sorter = new FinalTeamProject_Fall2021_Sec06.huskySort.sort.huskySort.HuskyBucketSort<>(16, huskyCoder, config);
            sorter.init(nWords);
            runStringSortBenchmark(words, nWords, nRuns, sorter, timeLoggersLinearithmic);
        }

        if (isConfigBenchmarkStringSorter("huskybucketintrosort"))
            runStringSortBenchmark(words, nWords, nRuns, new FinalTeamProject_Fall2021_Sec06.huskySort.sort.huskySort.HuskyBucketSort<>(1000, huskyCoder, config), timeLoggersLinearithmic);

...
import FinalTeamProject_Fall2021_Sec06.huskySort.util.LazyLogger;
...
public abstract class QuickSort<X extends Comparable<X>> extends SortWithHelper<X> {
     ...
     */
    public abstract FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partitioner<X> createPartitioner();
     ...
     */
    public void setPartitioner(FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partitioner<X> partitioner) {
    ...
    void sort(X[] xs, int from, int to, int depth) {
        ...
        FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partition<X> partition = createPartition(xs, from, to);
        if (partitioner == null) throw new RuntimeException("partitioner not set");
        List<FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partition<X>> partitions = partitioner.partition(partition);
     ...
     */
    public static <Y extends Comparable<Y>> FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partition<Y> createPartition(Y[] ys, int from, int to) {
        return new FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partition<>(ys, from, to);
    }

    public static <Y extends Comparable<Y>> FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partition<Y> createPartition(Y[] ys) {
    ...
    protected FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partitioner<X> partitioner;

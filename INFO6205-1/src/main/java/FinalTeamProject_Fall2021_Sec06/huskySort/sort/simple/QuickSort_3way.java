...
public class QuickSort_3way<X extends Comparable<X>> extends QuickSort<X> {
     ...
     */
    public FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partitioner<X> createPartitioner() {
    ...
    final class Partitioner_3Way implements FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.Partitioner<X> {

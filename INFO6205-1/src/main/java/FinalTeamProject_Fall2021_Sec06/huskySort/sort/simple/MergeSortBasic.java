...
public class MergeSortBasic<X extends Comparable<X>> extends SortWithHelper<X> {
    ...
    public MergeSortBasic(Helper<X> helper) {
        super(helper);
        insertionSort = new FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.InsertionSort<>(helper);
    }
    ...
    public MergeSortBasic(int N, Config config) {
        ...
        insertionSort = new FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.InsertionSort<>(getHelper());
    }
    ...
    private X[] aux = null;
    private final FinalTeamProject_Fall2021_Sec06.huskySort.sort.simple.InsertionSort<X> insertionSort;
}

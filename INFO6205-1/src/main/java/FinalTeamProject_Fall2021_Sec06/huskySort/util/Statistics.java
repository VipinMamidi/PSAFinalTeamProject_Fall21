...
public class Statistics {
    ...
    public String toString() {
        ...
        if (updated) {
            ...
            sb.append(s).append(FinalTeamProject_Fall2021_Sec06.huskySort.util.Utilities.asInt(mean()));
            if (stats)
                sb.append("; stdDev=").append(FinalTeamProject_Fall2021_Sec06.huskySort.util.Utilities.asInt(stdDev()));
        } else
            sb.append("<unset>");
        return sb.toString();
    }

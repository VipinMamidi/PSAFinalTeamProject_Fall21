...
public final class SorterBenchmark<T extends Comparable<T>> extends Benchmark<T[]> {
    ...
    private final static FinalTeamProject_Fall2021_Sec06.huskySort.util.LazyLogger logger = new FinalTeamProject_Fall2021_Sec06.huskySort.util.LazyLogger(SorterBenchmark.class);

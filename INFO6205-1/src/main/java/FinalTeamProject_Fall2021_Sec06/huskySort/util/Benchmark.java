...
package FinalTeamProject_Fall2021_Sec06.huskySort.util;
...
import static FinalTeamProject_Fall2021_Sec06.huskySort.util.Utilities.formatWhole;
...
public class Benchmark<T> {
    ...
    public double run(final Supplier<T> supplier, final int m) {
        ...
        new FinalTeamProject_Fall2021_Sec06.huskySort.util.Timer().repeat(getWarmupRuns(m), supplier, function, fPre, null);

        // Timed phase
        return new FinalTeamProject_Fall2021_Sec06.huskySort.util.Timer().repeat(m, supplier, function, fPre, fPost);
    }
    ...
    final static FinalTeamProject_Fall2021_Sec06.huskySort.util.LazyLogger logger = new FinalTeamProject_Fall2021_Sec06.huskySort.util.LazyLogger(Benchmark.class);
}

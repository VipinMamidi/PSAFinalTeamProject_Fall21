...
public class Timer {
    ...
    final static FinalTeamProject_Fall2021_Sec06.huskySort.util.LazyLogger logger = new FinalTeamProject_Fall2021_Sec06.huskySort.util.LazyLogger(Timer.class);

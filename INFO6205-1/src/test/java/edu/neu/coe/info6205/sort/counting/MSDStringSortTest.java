...
public class MSDStringSortTest {
    ...
    String[] input = "she sells seashells by the seashore the shells she sells are surely seashells, seashells, seashells, seashells".split(" ");
    String[] expected = "are by seashells seashells seashells seashells seashells seashore sells sells she she shells surely the the".split(" ");
